	...
	conns = [];
	gamestarted=false;
	roomname = (!isHeroku && !isLocalhost) ? QueryString["room"] : QueryString["id"];	//basically /room?id= versus /play.html?room= >> should make both '?room=' for less headache
	...
	function connectToBroker () {
		...
		peer = new Peer(genPredId(20), {host: 'tilebattlebroker.herokuapp.com', port: 80, path: '/', 
										config: {'iceServers': [
